...
const Signup = () => {
    ...
    return (
        ...
        <div className="Page-Header">
            ...
            <button className="Login Header-fonts" onClick={handleLoginButtonClick}> Login</button>
        </div>
        ...
        <div className="Signup-box">
            ...
            <input type="text" className="Eml-textbox Signup-textbox" id="email"
            placeholder="Enter Email ID"
            value={state.email}
            onChange={handleChange}
            />
            <p className="Category Signup-text"> Category </p>
            <select className="Dropdown Signup-textbox" id="dropdown" value={state.dropdown} onChange={handleChange}>
            ...
            <input type="password" className="Cpass-textbox Signup-textbox" id="cpass" placeholder="Confirm Password" />
            <button className="Create-account-button" onClick={handleLoginButtonClick}> Create Account </button>
        </div>
        <hr className="Line" />
        <div className="Box1">
                <p> Present Idea </p>
